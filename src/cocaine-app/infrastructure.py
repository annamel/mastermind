...
class Infrastructure(object):
    ...
    def cleanup_cmd(self,
        ...
        cmd = self.CLEANUP_CMD.format(
            ...
            attemps=(attemps if attemps else CLEANUP_CNF.get('attemps', 3)),
            wait_timeout=(wait_timeout if wait_timeout else CLEANUP_CNF.get('wait_timeout', 20)),
            nproc=(nproc if nproc else CLEANUP_CNF.get('nproc', 10)),
            batch_size=(batch_size if batch_size else CLEANUP_CNF.get('batch_size', 100)),
            trace_id=trace_id,
